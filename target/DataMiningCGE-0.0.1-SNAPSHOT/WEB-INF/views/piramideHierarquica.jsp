      ...
      <div class="mainbar">
        ...
        <div class="panel panel-default">
					<div class="panel-body">
						...
						<div id=input_categoria class=col-lg-3 style="left:30px; top:0px;display:none">
						...
						<div id=input_orgao class=col-lg-3 style="left:30px; top:0px;display:none">
						...
						<div id=gifCarregando class=col-lg-3 style="right :100px;display:none">
						...
						<div id=datas class=col-lg-3 style="left: 80px; top: 0px;display:none">
							<h6 style="text-align: left">
								<b>Janela de Tempo</b>
							</h6>
					...
					<div id="grafico"
						style="width: 600px; height: 500px; margin: 0 auto;display:none"></div>
				</div>
