							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									...
									<div class="modal-header">
										...
										<h4 class="modal-title">Informações do Servidor</h4>
									</div>
									...
									<div id="gif_modal"
										style="width: 600px; height: 500px; display: none; margin: 0 auto">
										<img
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<h4 style="text-align: center">
									<b>Dispersão Salarial dos Servidores </b>
								</h4>
								<hr>
									<h5 style="text-align: center">Nesta funcionalidade o
										usuario deve definir um cargo/orgão para realizar a busca.</h5>
									<hr>
										...
										<div class=col-lg-6 style="left: 150px">
											...
											<div id=datas class=col-lg-12 style="display: none;">
												<h6 style="text-align: center">
													<b>Janela de Tempo</b>
												</h6>
											...
											<div id=tipo_de_salario class=col-lg-12
												style="display: none;">
												<h6 style="text-align: center">
													<b>Tipo de Salário</b>
												</h6>
											...
											<div id=pesquisar class=col-md-12
												style="text-align: center; top: 20px; display: none;">
							...
							<div class="col-lg-2" style="left: 600px; top: 0px;">
								<form id="exportar" action="download" method="post"
									style="display: none;">
									<input id="escondido1" type="hidden" name="opcao1"> <input
										id="escondido6" type="hidden" name="opcao2"> <input
											id="escondido7" type="hidden" name="opcao3"> <input
												id="escondido5" type="hidden" name="filtro"> <input
													id="escondido2" type="hidden" name="referencia"> <input
														type="hidden" name="funcionalidade" value="dispersao">
							...
							<div class="panel-body">
								...
								<div id="container"
									style="display: none; width: 600px; height: 500px; margin: 0 auto"></div>
							</div>

							<div class="panel-body">

								<div id="gifGrafico"
									style="width: 700px; height: 500px; display: none; margin: 0 auto">
									<img
										src='http://i.kinja-img.com/gawker-media/image/upload/chag4hzw0pgvgy5ujnom.gif' />
								</div>
									...
									.click(
											function() {
												...
												if (datas['tipo'] == 'cargo') {
													...
													document
															.getElementById("escondido2").value = datas['referencia'];
													document
															.getElementById("escondido4").value = datas['referencia'];
													document
															.getElementById("escondido5").value = 'cargo';
													document
															.getElementById("escondido6").value = datas['input2'];
													document
															.getElementById("escondido7").value = datas['input3'];
												...
												if (datas['tipo'] == 'orgao') {
													...
													document
															.getElementById("escondido1").value = datas['input3'];
													document
															.getElementById("escondido2").value = datas['referencia'];
													document
															.getElementById("escondido4").value = datas['referencia'];
													document
															.getElementById("escondido5").value = 'orgao';
													document
															.getElementById("escondido6").value = datas['input2'];
													document
															.getElementById("escondido7").value = datas['input1'];
												}
																						...
																						$
																								.ajax({
																									...
																									success : function(
																											dataServ) {
																										document
																												.getElementById("escondido3").value = dataServ.matricula;
																										$(
																												'#myModal')
																												.modal(
																														'toggle');
																										...
																										element.innerHTML = '<b>Matricula: </b>'
																												+ dataServ.matricula;
																										element = document
																												.getElementById('cpf');
																										element.innerHTML = '<b>CPF: </b>'
																												+ dataServ.cpf;
																										element = document
																												.getElementById('nome_servidor');
																										element.innerHTML = '<b>Nome: </b>'
																												+ dataServ.nome;
																										element = document
																												.getElementById('cargo_descricao');
																										element.innerHTML = '<b>Cargo: </b>'
																												+ dataServ.cargo_descricao;
																										element = document
																												.getElementById('categoria_descricao');
																										element.innerHTML = '<b>Categoria: </b>'
																												+ dataServ.categoria;
																										element = document
																												.getElementById('dataNascimento');
																										element.innerHTML = '<b>Data de Nascimento: </b>'
																												+ dataServ.data_nascimento;
																										element = document
																												.getElementById('dataAdmissao');
																										element.innerHTML = '<b>Data de Admissão: </b>'
																												+ dataServ.data_admissao;
																										element = document
																												.getElementById('orgao_descricao');
																										element.innerHTML = '<b>Órgão: </b>'
																												+ dataServ.orgao_descricao;
																										...
																										for (i = 0; i < dataServ.movimentos.length; i++) {
																											...
																											element.innerHTML = element.innerHTML
																													+ '<tr><td>'
																													+ dataServ.movimentos[i].financeiro_descricao
																													+ '</td><td>'
																													+ dataServ.movimentos[i].valor
																													+ '</td><td>'
																													+ dataServ.movimentos[i].tipo
																													+ '</td></tr>';
																										}
																										element.innerHTML = element.innerHTML
																												+ '<tr><td>SALÁRIO BRUTO</td><td>'
																												+ Number(dataServ.salarioBruto).toFixed(2) 
																												+ '</td><td></td></tr>';
																										element.innerHTML = element.innerHTML
																												+ '<tr><td>SALÁRIO LÌQUIDO</td><td>'
																												+ Number(dataServ.salarioLiquido).toFixed(2)
																												+ '</td><td></td></tr>';
